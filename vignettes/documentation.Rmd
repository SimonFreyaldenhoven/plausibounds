...
#>  [1] -0.17482676 -0.02004318 -0.10031844  0.07229334
#>  [5] -0.31769306  0.01454694  0.06322594 -0.04186633
#>  [9]  0.12340034 -0.04534908 -0.16169097 -0.20259667
#> [13] -0.03298893 -0.02878808 -0.11865547 -0.33781817
#> [17] -0.04988252 -0.23286451 -0.34721788 -0.31989801
#> [21] -0.37015145 -0.18439333 -0.08283743 -0.06628430
#> [25]  0.07793498 -0.16041782  0.08020676 -0.26365956
#> [29] -0.09156697 -0.08646877  0.17552747 -0.26331948
#> [33]  0.26817909  0.21390666  0.02886865 -0.03854033
#> [37] -0.17947818 -0.04629705 -0.26782818  0.03586062
#> [41]  0.17248994 -0.01214121 -0.08781408  0.12013731
print(var_smooth[1:4, 1:4])
#> Warning in print(var_smooth[1:4, 1:4]): internal error 1
#> in R_decompress1 with libdeflate
#> Error in print(var_smooth[1:4, 1:4]): lazy-load database 'C:\Users\c1rak01\AppData\Local\R\win-library\4.4\plausibounds/data/Rdata.rdb' is corrupt
```
...
#> Error: lazy-load database 'C:\Users\c1rak01\AppData\Local\R\win-library\4.4\plausibounds/data/Rdata.rdb' is corrupt

pb <- plausible_bounds(
  estimates = estimates_smooth_nopretrends,
  var = var_smooth_nopretrends
)
#> Error: object 'var_smooth_nopretrends' not found
```
...
The restricted bounds tend to be wider than in the IID case due to the correlation structure.
...
#> Warning in plausible_bounds(estimates = estimates_smooth,
#> var = var_smooth, : restarting interrupted promise
#> evaluation
#> Warning in plausible_bounds(estimates = estimates_smooth,
#> var = var_smooth, : internal error 1 in R_decompress1 with
#> libdeflate
#> Error in plausible_bounds(estimates = estimates_smooth, var = var_smooth, : lazy-load database 'C:\Users\c1rak01\AppData\Local\R\win-library\4.4\plausibounds/data/Rdata.rdb' is corrupt
```


``` r
create_plot(pb_pre)
#> Error: object 'pb_pre' not found
```
